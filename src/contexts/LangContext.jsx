...
export const T = {
  ...
  // Home
  search_btn: { mm: 'လုပ်ငန်း/ဝန်ဆောင်မှု ရှာမယ်', en: 'Find Business / Service' },
  listings_count: { mm: 'လုပ်ငန်းများ', en: 'Listings' },
  ...
  no_results: { mm: 'မတွေ့ပါ', en: 'No results found' },
  ...
  claim_business: { mm: 'ဒါ ကျွန်တော်လုပ်ငန်း', en: 'Claim this Business' },
  ...
  // Submit
  submit_title: { mm: 'လုပ်ငန်း/ဝန်ဆောင်မှု ထည့်မည်', en: 'Add Listing / Service' },
  logo_label: { mm: 'Logo / ပုံ', en: 'Logo / Photo' },
  upload_logo: { mm: 'Logo တင်ရန်', en: 'Upload Logo' },
  name_en: { mm: 'အမည် (English)', en: 'Business Name (English)' },
  name_mm_label: { mm: 'အမည် (မြန်မာ)', en: 'Business Name (Myanmar)' },
  category_label: { mm: 'အမျိုးအစား', en: 'Category' },
  category_placeholder: { mm: '— ရွေးချယ်ရန် —', en: '— Select category —' },
  desc_label: { mm: 'ဖော်ပြချက်', en: 'Description (Myanmar)' },
  desc_placeholder: { mm: 'လုပ်ငန်း/ဝန်ဆောင်မှု အကြောင်း...', en: 'About your business...' },
  ...
  submit_btn: { mm: 'တင်သွင်းမည်', en: 'Submit Listing' },
  uploading: { mm: 'တင်သွင်းနေသည်...', en: 'Submitting...' },
  submit_notice: { mm: 'Admin မှ စစ်ဆေးပြီးနောက် ထည့်သွင်းပေးမည်', en: 'Admin will review and publish your listing' },
  ...
  go_directory: { mm: 'ပြန်ကြည့်မည်', en: 'Browse Directory' },
  // Profile
